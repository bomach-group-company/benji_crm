...
class SuspendMyVendor extends StatefulWidget {
  const SuspendMyVendor({super.key});

  @override
  State<SuspendMyVendor> createState() => _SuspendMyVendorState();
}

class _SuspendMyVendorState extends State<SuspendMyVendor> {
  //============================================ ALL VARIABLES ===========================================\\
