...
class DeleteMyVendor extends StatefulWidget {
  const DeleteMyVendor({super.key});

  @override
  State<DeleteMyVendor> createState() => _DeleteMyVendorState();
}

class _DeleteMyVendorState extends State<DeleteMyVendor> {
  //============================================ ALL VARIABLES ===========================================\\
            ...
            return ListView(
              ...
              children: [
                ...
                SizedBox(
                  width: 332,
                  child: Text(
                    'Tell us why you want this vendor deleted',
                    style: TextStyle(
