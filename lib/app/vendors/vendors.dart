                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          decoration:
                                                                              ShapeDecoration(
                                                                            color: 
                                                                                 vendor[index].isOnline == true
                                                                              ?   _vendorActiveColor : _vendorInactiveColor ,
                                                                            shape:
                                                                                const OvalBorder(),
                                                                          ),
                                                                        ),
                                                                        ...
                                                                        Text(
                                                                          ...
                                                                          style:
                                                                              TextStyle(
                                                                            color: vendor[index].isOnline == true
                                                                                ? kSuccessColor
                                                                                : kErrorColor,
                                                                            fontSize:
                                                                                14,
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            "${double.tryParse(vendor[index].averageRating.toString())!.toStringAsFixed(1)} ",
                                                                            style:
                                                                                const TextStyle(
