...
class ReportThirdPartyVendor extends StatefulWidget {
  ...
  const ReportThirdPartyVendor({super.key, required this.vendor});

  @override
  State<ReportThirdPartyVendor> createState() => _ReportThirdPartyVendorState();
}

class _ReportThirdPartyVendorState extends State<ReportThirdPartyVendor> {
  @override
  void initState() {
