...
class ChangeThirdPartyProductImage extends StatefulWidget {
  final ProductModel product;

  const ChangeThirdPartyProductImage({super.key, required this.product});

  @override
  State<ChangeThirdPartyProductImage> createState() =>
      _ChangeThirdPartyProductImageState();
}

class _ChangeThirdPartyProductImageState
    extends State<ChangeThirdPartyProductImage> {
  @override
  void initState() {
    super.initState();
