...
class AddThirdPartyBusinessProduct extends StatefulWidget {
  ...
  const AddThirdPartyBusinessProduct({super.key, required this.business});

  @override
  State<AddThirdPartyBusinessProduct> createState() =>
      _AddThirdPartyBusinessProductState();
}

class _AddThirdPartyBusinessProductState
    extends State<AddThirdPartyBusinessProduct> {
  @override
  void initState() {
    super.initState();
    isToggled = true;
  ...
  Future<void> submit() async {
    if (selectedImage == null) {
      ApiProcessorController.errorSnack("Please add a product image");
      return;
    }
